...
const GOOGLE_ONLY = ["Merchant Center", "Performance Max", "PMax", "Google Shopping", "Shopping-feed",
  "tROAS", "Dynamic Search Ads", "zoekwoord"];

function promptsVoor(kanaal: "google_ads" | "meta_ads" | "linkedin_ads"): Record<string, string> {
  return {
...
console.log("\nGoogle is niet veranderd, en het gedeelde vakmanschap blijft gedeeld");
{
  ...
  for (const kanaal of ["google_ads", "meta_ads", "linkedin_ads"] as const) {
