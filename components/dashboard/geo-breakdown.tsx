  ...
  return (
    <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
      ...
      {/* Kaart en ranglijst naast elkaar. Twee vragen, twee vormen: de kaart zegt WAAR, de
          ...
          een projectie af -- daar wint Groenland altijd. De ruimte naast de kaart was op een breed
          scherm leeg; nu draagt hij de cijfers die anders een klik weg zaten. */}
      ...
      {/* 22 augustus 2026: op een brede monitor bleef er zowel naast de kaart als naast de smalle
          17rem-ranglijst dode ruimte over -- de kaart zelf niet groter (760px = zijn eigen
          SVG-viewBox 1:1, meer zou 't alleen hoger maken zonder leesbaarder te worden, exact de
          reden waarom de cap er ooit kwam), maar de kolom eromheen wel: max-w-6xl op de hele kaart
          zodat de rest van de breedte niet als leegte oogt, en een bredere ranglijst-kolom die de
          winst opeet in plaats van hem te laten liggen. */}
      <div className="max-w-6xl mx-auto grid grid-cols-1 gap-5 px-3 py-3 xl:grid-cols-[minmax(0,1fr)_21rem] xl:items-start">
